...
namespace LibraryForParkinLogic
{
    public class Parking
    {
        ...
        //private static readonly log4net.ILog log = log4net.LogManager.GetLogger(getParking().GetType());
        ...
        private Parking()
        {
            ...
            Timer timer = new Timer(t1, this, 0, 2000);
            Timer timer2 = new Timer(t2, this, 0, 60000);
        ...
        public Boolean AddCar(Car car)
        {
            if (FreeSize() > 0)
            {
                if (cars.Find(x => x.Id == car.Id) == null)
                {
                    cars.Add(car);
                    return true;
                }
                //log.Info("Car with that id is already exist on parking" + car.Id);
                return false;
            }
            else
            {
        ...
        public static void SaveTrancsactions(object obj)
        {
            ...
            //InfoLogger.Log.Info("Sum of transactions: " + sum);
        }
        ...
        public static void CarsPay(object obj)
        {
            ...
            foreach(Car car in p.cars)
            {
                ...
                {
                    //InfoLogger.Log.Info("This car id is already exist on parking");
                }
            }
